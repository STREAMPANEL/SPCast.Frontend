...
{include file="$template/includes/subheader/partials/spsm/content_overview/autodj_backupfiles.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/autodj_backupfiles.tpl"}
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function(e) {
            FormValidation.formValidation(
                document.getElementById('SPCastUploadBackupfiles'), {
                    plugins: {
