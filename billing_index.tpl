...
{include file="$template/includes/subheader/partials/spsm/content_overview/billing_index.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/billing_index.tpl"}
