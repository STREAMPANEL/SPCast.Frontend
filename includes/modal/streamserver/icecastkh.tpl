    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <strong>HTML 5 Player:</strong> <a href="https://{$spHostname}:8110/" target="_blank" rel="noopener">https://{$spHostname}:8110/</a><br /><br />
                ...
                <strong>Windows Media Player:</strong> <a href="https://{$spHostname}:8110/listen.asx" target="_blank" rel="noopener">https://{$spHostname}:8110/listen.asx</a><br />
                <strong>Real Player:</strong> <a href="https://{$spHostname}:8110/listen.ram" target="_blank" rel="noopener">https://{$spHostname}:8110/listen.ram</a><br />
