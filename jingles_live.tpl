...
{include file="$template/includes/subheader/partials/spsm/content_overview/jingles_live.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/jingles_live.tpl"}
