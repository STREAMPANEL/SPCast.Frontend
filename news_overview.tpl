...
{include file="$template/includes/subheader/partials/spsm/content_overview/news_overview.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/news_overview.tpl"}
