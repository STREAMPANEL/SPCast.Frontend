    ...
    <div class="col-xl-12">
        <div class="card card-custom sp-margin-bottom">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-xl-3">
                        <div class="card card-custom card-stretch bgi-no-repeat sp-margin-bottom bg-hover-state-white"
    ...
    <div class="col-xl-12">
        <div class="card card-custom sp-margin-bottom">
            <div class="card-header border-0 sp-bg-dark">
                <div class="card-title">
                    <h3 class="card-label text-white">
                        {lang key='sp_spcast_metro_spcast_automation'}
                    </h3>
                </div>
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-12">
        <div class="card card-custom sp-margin-bottom">
            <div class="card-header border-0 sp-bg-dark">
                <div class="card-title">
                    <h3 class="card-label text-white">
                        {lang key='sp_spcast_metro_spcast_tools'}
                    </h3>
                </div>
            </div>
            <div class="card-body">
