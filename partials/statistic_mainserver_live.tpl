<div class="card card-custom sp-margin-bottom">
    <div class="card-header border-0 sp-bg-dark">
        <div class="card-title">
            <h3 class="card-label text-white">
                Hauptserver<br />
                <small>Die aufgerufene Statistik gibt Informationen zum Hauptserver und zu den Zuhörern aus.</small>
            </h3>
        </div>
    ...
    <div class="card-body">
        <iframe id="spExternalIframeStatistic" frameborder="0" src="https://{$spHostname}:9010/d/f35f7f68-71a7-4d9d-ae09-625fb5b92e1f/mainserver-live?orgId=1&refresh=15s&theme=light&kiosk=tv"
            title="Statistik: Hauptserver"></iframe>
    </div>
</div>