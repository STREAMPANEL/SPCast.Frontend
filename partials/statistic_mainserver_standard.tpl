<div class="card card-custom sp-margin-bottom">
    ...
    <div class="card-body">
        <iframe id="spExternalIframeStatistic" frameborder="0" src="https://{$spHostname}:9010/d/VS_XsQWVz/mainserver?orgId=1&refresh=15s&theme=light&kiosk=tv" title="Statistik: Hauptserver"></iframe>
    </div>
</div>