<div class="alert alert-primary" role="alert">
    <ul>
        <li>Wenn Sie Metadaten abrufen möchten schauen Sie im Bereich <a href="index.php?m=SPStreamserverManagement&spserviceid=7984&spsmpageid=305&metro=widgets" class="sp-red">Programmdetails</a> um diese auf
