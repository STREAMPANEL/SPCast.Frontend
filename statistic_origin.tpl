...
{include file="$template/includes/subheader/partials/spsm/content_overview/statistic_origin.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/statistic_origin.tpl"}
