...
{include file="$template/includes/subheader/partials/spsm/content_overview/statistic_system_overview.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/statistic_system_overview.tpl"}
