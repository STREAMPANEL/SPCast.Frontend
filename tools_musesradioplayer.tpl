...
{include file="$template/includes/subheader/partials/spsm/content_overview/tools_musesradioplayer.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/tools_musesradioplayer.tpl"}
