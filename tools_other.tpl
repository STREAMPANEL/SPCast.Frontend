...
{include file="$template/includes/subheader/partials/spsm/content_overview/tools_other.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/tools_other.tpl"}
