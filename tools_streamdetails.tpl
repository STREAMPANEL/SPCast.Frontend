...
{include file="$template/includes/subheader/partials/spsm/content_overview/tools_streamdetails.tpl"}
...
{elseif $spFirstStart == "1" && $spHasAccess == "1"}
    ...
    {include file="modules/addons/SPStreamserverManagement/templates/partials/tools_streamdetails.tpl"}
...
{if $spCNAMELoadBalancer}
    <script src="https://{$spCNAMELoadBalancer}/scripts/js/details.min.js"></script>
{else}
